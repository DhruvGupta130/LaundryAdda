...
import {FETCH_AREAS, GOOGLE_MAPS_API_KEY} from "../../../../utils/config.js";

const LIBRARIES = ["places", "geometry"];

const AddAddressModal = ({ open, handleClose, setToast, setLaundry }) => {
    ...
    const handleSubmit = useCallback(
        ...
        [address, handleClose, setLaundry]
    );
            ...
            <Box className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg w-[500px] max-w-[90vw] max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex flex-col relative mb-4">
                    <label className="block text-sm font-medium text-gray-700">
                        Pick your location on map (click to select) or use current location{" "}
                    ...
                    <div className="relative">
                        {isLoaded ? (
                            <GoogleMap
                                mapContainerClassName="h-[250px] mt-2 rounded-md border border-black"
                                center={position}
                                zoom={15}
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex gap-3 mt-6 justify-end">
                        ...
                        <Button variant="outlined" onClick={resetForm} color="secondary">
                            Cancel
                        </Button>
                    </div>
                </form>
