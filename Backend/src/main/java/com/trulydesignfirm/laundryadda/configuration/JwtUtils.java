...
public class JwtUtils {
    ...
    static {
        try {
            ...
            key = Keys.hmacShaKeyFor("sdkjgholisdhfio;asdhfio;shfoisdhfgolidshfolasbniofhnsaofbnasiodfbnasojklfbjikolasbf kjbawiolufgblhjiksawebfvioluas biksdubwseailukb".getBytes());
